...
public class CircleBreakerController
{
    ...
    /**
     *  fallback和blockHandler都配时，则被限流降级而抛出BlockException时只会进入blockHandler处理逻辑，当没达到限流规则时，出现异常就会被fallback兜底
     *  exceptionsToIgnore属性指当出现该指定的异常时，不再有fallback方法兜底，没有降级效果
     */
